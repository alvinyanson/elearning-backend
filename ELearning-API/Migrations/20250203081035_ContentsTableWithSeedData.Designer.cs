...
namespace ELearning_API.Migrations
{
    ...
    [Migration("20250203081035_ContentsTableWithSeedData")]
    partial class ContentsTableWithSeedData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ELearning_API.Models.Content", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("06d93e6c-4d65-429d-8a40-e0e5cf5e9d5a"),
                            AuthorId = "81213A50-758E-4904-B715-640038EE9CD9",
                            CreatedAt = new DateTime(2025, 2, 3, 8, 10, 34, 635, DateTimeKind.Utc).AddTicks(364),
                            HTMLContent = "<p>Introduction to the course</p>",
                            IsPublished = true,
                            ModuleId = new Guid("3f7654fe-0ad8-4289-9436-04ce9005f500"),
                            Type = "Text",
                            UpdatedAt = new DateTime(2025, 2, 3, 8, 10, 34, 635, DateTimeKind.Utc).AddTicks(367)
                        });
                });
            ...
            modelBuilder.Entity("ELearning_API.Models.Content", b =>
                {
                    ...
                    b.HasOne("ELearning_API.Models.Module", "Module")
                        .WithMany()
