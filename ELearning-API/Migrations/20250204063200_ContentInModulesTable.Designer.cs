...
namespace ELearning_API.Migrations
{
    ...
    [Migration("20250204063200_ContentInModulesTable")]
    partial class ContentInModulesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ELearning_API.Models.Content", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("08f6938b-e1f1-493c-9ddf-78238b0de90c"),
                            AuthorId = "81213A50-758E-4904-B715-640038EE9CD9",
                            CreatedAt = new DateTime(2025, 2, 4, 6, 31, 59, 909, DateTimeKind.Utc).AddTicks(9718),
                            HTMLContent = "<p>Introduction to the course</p>",
                            IsPublished = true,
                            ModuleId = new Guid("3f7654fe-0ad8-4289-9436-04ce9005f500"),
                            Type = "Text",
                            UpdatedAt = new DateTime(2025, 2, 4, 6, 31, 59, 909, DateTimeKind.Utc).AddTicks(9720)
                        });
                });
